#!/usr/bin/env python3
"""
实验: Comprehensive Leave-One-Out & Leave-K-Out 验证 [ours, 验证 TracIn 预测]。
...
def main():
    ...
    for c in args.classes:
        ...
        scores = np.load(f"./results/oct_mia_tracin/tracin/scores_class{c}.npz")["scores"]
        ...
        ax.set_xlabel("TracIn Score"); ax.set_ylabel("Δloss (mean over seeds)")
